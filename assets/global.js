...
class SliderComponent extends HTMLElement {
  ...
  onButtonClick(event) {
    ...
    console.log(step, step * this.sliderItemOffset, this.slider.scrollLeft);
...
updateVariantDetails(currentVariant) {
    ...
    for(let vr=0; vr< variants.length; vr++ ){
      ...
      if(my_variant_id == currentVariant.id &&  my_variant_preOrder == 'true'){
        console.log("yesss");
  ...
  const variants_preOrdertext = document.querySelectorAll('.preorder_text_regular');
    ...
    for(let vt=0; vt < variants_preOrdertext.length; vt++ ){
      ...
      if(vt_variant_id == currentVariant.id &&  vt_variant_preOrder == 'true'){
        console.log("yesss");
  ...
  updateMasterId() {
    ...
    console.log("check the variant: ", this.currentVariant, "check variant price: ", this.currentVariant.price);
    // const updated_variant_price = this.currentVariant.price;
    // console.log("updated price: ", updated_variant_price);
    // const add_price = document.querySelector(".product-form form .product-form__buttons .product-form__submit");
    // console.log(add_price);
    // add_price.textContent = ''
    // let extra_span = document.createElement("span");
    // extra_span.textContent = updated_variant_price; 
    // add_price.appendChild(extra_span);


    var get_element = document.querySelector("variant-radios");
    console.log(get_element);
    get_element.setAttribute("data-current_id", this.currentVariant.id);
    console.log("Check id: ", this.currentVariant.id, "check whole variant: ", this.currentVariant, "check availability: ", this.currentVariant.available);
    var new_add_btn_sticky_regular = document.querySelector(".new_add_btn_sticky_regular");
    var variant_availablity = this.currentVariant.available;
  new_add_btn_sticky_regular.value = '';
  new_add_btn_sticky_regular.value = this.currentVariant.id;
  if(variant_availablity){
    // document.querySelector(".preorder_text_regular").style.display = 'none'
    // document.querySelector(".in-stock-regular").style.display = 'flex'
    // document.getElementById("regular_preorder_btn").style.display = 'none'
    // document.getElementById("count_down_regular").style.display = 'block';

  }
  else{
    // document.querySelector(".preorder_text_regular").style.display = 'flex'
    // document.querySelector(".in-stock-regular").style.display = 'none'
    // document.getElementById("regular_preorder_btn").style.display = 'block'
    // document.getElementById("count_down_regular").style.display = 'block';
  }
  ...
  updateVariantInput() {
    ...
    const updatedVariantPrice = document.querySelector(".price-item.price-item--sale.price-item--last.bb").textContent;
console.log("updated price: ", updatedVariantPrice);

// Select the element where you want to display the price
const addPriceElement = document.querySelector(".product-form form .product-form__buttons .product-form__submit");
console.log(addPriceElement);

// Function to update the price
function updatePrice() {
    const extraSpan = document.createElement("span");
    extraSpan.textContent = `ADD TO CART ${updatedVariantPrice}`;
    addPriceElement.textContent = '';
    addPriceElement.appendChild(extraSpan);
}

// Set an interval to update the price every 5 seconds (5000 milliseconds)
const intervalID = setInterval(updatePrice, 1000);

// Set a timeout to clear the price update after 20 seconds (20000 milliseconds)
setTimeout(() => {
